...
import CardTable3 from "components/Cards/CardTable3";
import CardTable4 from "components/Cards/CardTable4";
...
export default function Transactions2() {
  ...
  const exportToPDF = () => {
    ...
    let pdfname = "Transactions_Report";
    ...
    <>
      <div className="flex flex-wrap mt-4">
        <div className="w-full mb-12 px-4">
          <CardTable4 cusRef={cusRef} exportToPDF={exportToPDF}/>
        </div>
